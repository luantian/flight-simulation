...
import { World, Vec3, Body, Sphere, Plane, Material } from "cannon-es";
...
export class Viewer {
    ...
    createLand() {
        ...
        floorMesh.position.y = -27;
        this.scene.add(floorMesh);
    }

    linkCannon(gltf: GLTF) {
        const scene = gltf.scene || gltf.scenes[0];
        scene.castShadow = true;
        scene.receiveShadow = true;
        console.log('scene', scene);
        // const trimesh = new Trimesh(
        //     scene.geometry.attributes.position.array,
        //     scene.geometry.index.array
        // );
        ...
        //     child.getWorldQuaternion(new Quaternion())
        // );
        // // 添加刚体到物理世界
