...
export class Viewer {
    ...
    constructor(element: HTMLElement, plane: IPlane, optinos?: any) {
        this.plane = plane;
    ...
    createLand() {
        ...
        this.floorMesh = new Mesh(floorGeometry, floorMat);
        this.floorMesh.receiveShadow = true;
        this.floorMesh.rotation.x = -Math.PI / 2.0;
        this.floorMesh.position.y = -25;
    ...
    linkCannon(gltf: GLTF, plane: IPlane) {
        ...
        this.floorMesh.position.copy(groundBody.position as unknown as Vector3)
        this.world.addBody(groundBody);
        const animate = () => {
            requestAnimationFrame(animate);
            this.world.fixedStep();
            scene.position.copy(boxBody.position as unknown as Vector3)
            scene.quaternion.copy(boxBody.quaternion as unknown as Quaternion)
